...
public class AppFileController {
    ...
    public void handleSaveCurrentRequest() {
        PropertiesManager props = PropertiesManager.getPropertiesManager();
        try {
    ...
    public void export(File selectedDirectory) {
        PropertiesManager props = PropertiesManager.getPropertiesManager();
        //File public_html = new File("..\\TAManagerTester\\public_html");
        //File currentFile = new File(currentWorkFile.toString());
        //File newFile = new File(selectedDirectory.toString() + "\\OfficeHoursGridData.json");
        
        //currentFile.renameTo(newFile);
        /*
        try {

            //FileUtils.copyDirectory(public_html, selectedDirectory);
        ...
        */
         ...
         try {
            File fileimport = new File("../public_html");
            String s = fileimport.getCanonicalPath();
            File source = new File(s);
            File export = new File(selectedDirectory.getPath() + "/public_html");
            FileUtils.copyDirectory(source, export);
            app.getFileComponent().exportData(app.getDataComponent(),selectedDirectory.getPath());
