...
/**
 * This class stores infor for a single TA-Day/Time mapping for our office hours
 * grid. It's useful to provide a list of these objects for file I/O.
 *
 * @author Jose
 */
public class TimeSlot {
    ...
    /**
     * This function builds a list of all the office hours stored in the grid
     * excluding empty time slots. This helps us do our file input since it
     * reflects how office hours are stored in the JSON file.
     */
